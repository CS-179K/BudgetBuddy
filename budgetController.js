...
// Function to check budget usage and create notifications
const checkBudgetUsage = async (userId) => {
    try {
        ...
        if (usagePercentage >= 100) {
            ...
            await createOrUpdateNotification(20, "Notice: You have used 20% of your budget.");
        }
...
const createBudget = async (req, res) => {
    ...
    try {
        ...
        // Check budget usage after creating the budget
